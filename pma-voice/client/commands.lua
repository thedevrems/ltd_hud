...
function setProximityState(proximityRange, isCustom)
	...
	-- Handed to external huds as a plain event, carrying the range name rather
	-- than the index. The statebag above says the same thing, but only after a
	-- round trip: a resource that missed the write, or started after it, gets
	-- nothing from it, which is exactly when a hud shows a stale range.
	TriggerEvent('pma-voice:proximityChanged', proximity)
end
...
RegisterCommand('cycleproximity', cycleProximity, false)
