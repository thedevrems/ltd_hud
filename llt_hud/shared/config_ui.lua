...
-- Show the "Press ENTER to continue" intro scene only while the player has no hud
-- stored locally. Set to false to play it on every connect, as a server intro.
