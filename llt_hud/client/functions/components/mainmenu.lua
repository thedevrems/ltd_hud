...
-- the player to press ENTER to build their interface. Once they have one stored
-- locally there is nothing left for it to introduce, so a reconnect walks past it
-- instead of showing a screen whose only action is "continue".
--
...
function MainMenu.Handler()
    Citizen.CreateThread(function()
        ...
        -- Storage.Data.UIConfigured only exists once the NUI has answered with what
        -- it found in localStorage, and the branch below reads it.
