...
const DEFAULT_ITEMS = {
    color: item("color", "Color", "fas fa-fill"),
    hud: item("hud", "Hud", "fas fa-heart"),
    carhud: item("carhud", "Car Hud", "fas fa-car"),
    notifications: item("notifications", "Notification", "fas fa-envelope-open"),
    progressBar: item("progressBar", "Progress Bar", "fas fa-circle-notch"),
    helpNotify: item("helpNotify", "Help Notify", "fas fa-question-circle"),
    misc: item("misc", "Misc", "fas fa-cogs"),
