...
import { setConfigured } from "../core/storage.js";
...
function applyServerPreset() {
    ...
    debug.log('step 3/3 -> setConfigured() (stored in ltl_hud_settings, so the welcome flow is skipped on every later spawn and on every character)');
    setConfigured();
