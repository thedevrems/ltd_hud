...
function saveUIColor(key) {
    return value => {
        setColor(key, value);
        // La primaire entraîne ses dérivées — l'accent du bandeau du joueur en
        // vient — donc elle passe par le thème et non par l'écriture directe.
        if (key === "primaryColor") return setPrimaryColor(value);
