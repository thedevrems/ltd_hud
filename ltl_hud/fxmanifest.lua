...
author '.zeusx#2743'
version '2.9'
description 'ltl_hud - User Interface for FiveM (LTL Framework + pma-voice)'
lua54 'yes'
...
files {
    ...
    'html/assets/*.ogg',
    'html/assets/*.wav',
    -- Server logo and any other artwork the page loads by relative path.
    'html/*.png',
    'html/*.jpg',
    'html/*.webp',
    'html/*.svg',
...
server_scripts {
    -- Le HUD de chaque compte vit en base (table ltl_hud_settings), donc oxmysql
    -- doit être chargé avant tout le reste du serveur.
